  ...
  return (
    <main className="billing-page p-4">
      <div className="d-flex justify-content-between align-items-center mb-5">
        <div>
          <h2 className="fw-bold mb-1">Invoice Generation</h2>
          <p className="text-muted mb-0">Manage clinical invoice generation and payment records.</p>
        </div>
        {canOperate && (
          ...
          <div className="table-responsive">
            ...
            <thead>
              <tr>
                ...
                <th className="py-3">Invoice Amt</th>
                ...
                <tr key={inv.id}>
                  ...
                  <td className="py-4 fw-bold" style={{ fontVariantNumeric: 'tabular-nums' }}>
                    ...
                    {(inv.cgst > 0 || inv.sgst > 0 || inv.igst > 0) && (
                      <div className="text-muted" style={{ fontSize: '0.72rem', fontWeight: 'normal', marginTop: '2px' }}>
                        {inv.igst > 0 ? (
                          <span>IGST: ₹{inv.igst.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                        ) : (
                          <span>CGST+SGST: ₹{(inv.cgst + inv.sgst).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                        )}
                      </div>
                    )}
                  </td>
