                ...
                <tr key={item.id}>
                  ...
                  <td>
                    <span 
                      ...
                      style={{ 
                        fontSize: '0.7rem',
                        background: item.status === 'In Stock' ? 'rgba(0, 112, 243, 0.1)' : 
                                   item.status === 'Low Stock' ? 'rgba(245, 166, 35, 0.1)' : 'rgba(238, 0, 0, 0.1)',
                        color: item.status === 'In Stock' ? 'var(--geist-success)' : 
                               item.status === 'Low Stock' ? 'var(--geist-warning)' : 'var(--geist-error)',
                        border: `1px solid ${item.status === 'In Stock' ? 'rgba(0, 112, 243, 0.2)' : 
                                           item.status === 'Low Stock' ? 'rgba(245, 166, 35, 0.2)' : 'rgba(238, 0, 0, 0.2)'}`
                      }}
                    >
                      {item.status}
                    </span>
