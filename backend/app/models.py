...
class Appointment(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, index=True)
    owner_user_id: Mapped[int] = mapped_column(Integer, index=True)
    appointment_code: Mapped[str] = mapped_column(String(20), unique=True, index=True)
    ...
    patient_mobile: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ...
    doctor_name: Mapped[str] = mapped_column(String(120), index=True, default="")
